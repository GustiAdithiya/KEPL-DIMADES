...
class EdibleProductController extends ProductController implements ControllerInterface
{
    /**
    ...
    {
        $category = Category::where('type','1')->orderBy('name', 'ASC')->get();
    ...
    public function edit($id)
    {
        ...
        return view('admin.food.edit', $this->data);
    }
